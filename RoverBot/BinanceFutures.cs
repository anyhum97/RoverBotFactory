...
namespace RoverBot
{
	...
	{
		public static string ApiKey => ApiAgent.ApiKey;

		public static string SecretKey => ApiAgent.SecretKey;
		...
		public const int DefaultLeverage = 5;
